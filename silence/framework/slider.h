...
public:
    ...
    inline c_slider_int(const std::string_view& name, const std::string_view& label, int* value, int min, int max, const std::string_view& format_str = "%d", const bool default_visibility = true) noexcept
    {
        ...
        this->m_min = min;
        this->m_max = max;
        this->m_type = framework_enums::element_type::SLIDER_INT;
...
public:
    ...
    inline c_slider_float(const std::string_view& name, const std::string_view& label, float* value, float min, float max, const std::string_view& format_str = "%.2f", const bool default_visibility = true) noexcept
    {
        ...
        this->m_min = min;
        this->m_max = max;
        this->m_type = framework_enums::element_type::SLIDER_FLOAT;
        this->m_format_text = format_str;
